...
- 程序运行后会显示同步的文件数量，以及其中的成功数量与失败数量，类似于下图：
  ![img](blob:https://diangroup.feishu.cn/77784387-8b21-4ad2-9994-cac41d929150)
  ![img](blob:https://diangroup.feishu.cn/8b1d31e7-87ce-49cd-9353-c56e2f18d19b)
  ![img](blob:https://diangroup.feishu.cn/dd983e95-61bd-4677-9b60-70fbc49f990f)在succeed.txt中保存着成功同步的xml文件的信息，包括该xml文件做出的改动（更改了哪些标签的数据、增删了哪些标签)
